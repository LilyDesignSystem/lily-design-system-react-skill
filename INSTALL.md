...
This repository is a Claude Skill covering everything available for React in Lily Design System (headless library, helpers catalog, and example app where one exists) for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-react-skill.git
```
